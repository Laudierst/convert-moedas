...
export default function Privacidade() {
    return (
        <div className="container">
            <h1 className="h1 mt-3">Política de Privacidade</h1>
            ...
            <p></p><strong>SEÇÃO 2 - CONSENTIMENTO</strong>
            ...
            <p>Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco por e-mail.  </p>
            <p></p><strong>SEÇÃO 3 - DIVULGAÇÃO</strong>
            ...
            <p></p><strong>SEÇÃO 4 - SERVIÇOS DE TERCEIROS</strong>
